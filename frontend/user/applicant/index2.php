...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center bg-dark">
        ...
        <a class="navbar-brand text-white" href="index2.php">HOME<span style="color:#0A9DF0;">AID</span></a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
                        <i class="bi bi-bell bi-bell-white"></i>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="../../../assets/img/Ivana.jpg" alt="Profile" class="rounded-circle">
                        <span class="d-none d-md-block dropdown-toggle ps-2 text-white">d. dragon</span>
        ...
        <div class="card bg-dark text-white my-2">
            <div class="card-header d-flex justify-content-between">
                <div class="img">
                    ...
                    <img src="../../../assets/img/jane.jpg" height="50" width="50" alt=""><span>glen</span>
