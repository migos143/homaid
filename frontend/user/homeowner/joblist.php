            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card bg-dark text-white rounded">
                        <div class="card-body">
                            <h5 class="card-title">JOBLIST</h5>
                            ...
                            <table class="table joblist text-white ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>cooking</td>
                                        <td>
                                            <button style="cursor: pointer" type="button" class="btn btn-primary btn-sm">aprove</button>
                                            <button style="cursor: pointer" type="button" class="btn btn-danger btn-sm">decline</button>
                                        </td>
        ...
        <div class=" fixed-bottom bg-dark p-0">
            <div class="footer-wrap row p-">
                <div class="col d-flex justify-content-center">
                    <h6 style="color:white">Copyright © HomeAID 20</h6>
                </div>
            </div>
        </div>
    </footer>
